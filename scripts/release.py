...
## [{new_version}] - {today}"""
    ...
    def run_linting(self) -> bool:
        ...
        try:
            ...
            self.run_command(["python", "-m", "mypy", "threepanewindows/", "--ignore-missing-imports"])
            return True
        except SystemExit:
    ...
    def release(self, new_version: str, release_type: str, skip_tests: bool = False) -> None:
...
def main():
    ...
    parser.add_argument("--version", required=True, help="New version number (e.g., 1.0.0)")
