...
class TestExamples:
    ...
    def test_run_demo_with_timeout(self):
        ...
        try:
            ...
            success = examples.run_demo_with_timeout(timeout_seconds=2, interactive=False)
    ...
    def test_demo_components_creation(self):
        ...
        try:
            ...
            expected_keys = ['dockable_window', 'fixed_layout', 'enhanced_window', 'builders']
            for key in expected_keys:
                assert key in results
                assert isinstance(results[key], bool)
    ...
    def test_run_demo_creates_window(self, mock_tk):
        ...
        with patch('threepanewindows.examples.DockableThreePaneWindow') as mock_dockable, \
             patch('threepanewindows.examples.FixedThreePaneLayout') as mock_fixed, \
             patch('threepanewindows.examples.EnhancedDockableThreePaneWindow') as mock_enhanced:
    ...
    def test_demo_builders_exist(self):
        ...
        demo_functions = [attr for attr in dir(examples) if 'demo' in attr.lower() or 'builder' in attr.lower()]
    ...
    def test_demo_with_different_types(self):
        ...
        try:
            ...
            examples.run_demo(interactive=False, auto_close_delay=100)  # With auto-close
        except TypeError:
...
class TestExampleIntegration:
    ...
    def test_examples_demonstrate_features(self):
        ...
        try:
            ...
            found_features = [feature for feature in key_features if feature in source.lower()]
