...
from threepanewindows.themes import get_theme_manager, ThemeType
...
class TestEnhancedDockableCoverage:
    ...
    def test_enhanced_window_advanced_methods(self):
        ...
        methods_to_test = [
            'save_layout', 'restore_layout', 'reset_layout',
            'toggle_left_pane', 'toggle_right_pane',
            'set_pane_visibility', 'get_pane_visibility',
            'update_pane_config', 'get_pane_config',
            'bind_keyboard_shortcuts', 'unbind_keyboard_shortcuts',
            'create_context_menu', 'show_context_menu',
            'save_state', 'restore_state', 'get_state'
        ]
        ...
        for method_name in methods_to_test:
            if hasattr(window, method_name):
                ...
                try:
                    if method_name in ['save_layout', 'save_state', 'get_state', 'get_pane_visibility']:
                        result = method()
                    elif method_name in ['toggle_left_pane', 'toggle_right_pane', 'reset_layout']:
                        method()
